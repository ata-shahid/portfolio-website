    ...
    <div className='pt-[4rem] md:pt-[8rem] pb-[5rem] bg-[#09101a]'>
      ...
      <div className='flex flex-wrap w-[80%] mx-auto pt-[4rem] md:pt:pt-[8rem] gap-[2rem] items-center'>
        <div className='flex-1'>
          ...
          <Language skill1="TypeScript" skill2="Tailwind CSS" skill3="Figma" level1="w-[91%]" level2="w-[88%]" level3="w-[80%]"/>
        </div>
        <div className='flex-1'>
          <Skill title="React & Next.js"/>
          <Skill title= "Back-End Development"/>
          <Language skill1="React & Next.js" skill2="Node.js" skill3="Adobe Creative Suite" level1="w-[91%]" level2="w-[80%]" level3="w-[60%]"/>
        </div>
      </div>
    </div>
  )
