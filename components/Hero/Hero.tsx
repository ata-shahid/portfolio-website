    ...
    <div className="relative h-[88vh] bg-[#0d1218] mt-[5vh] bg-cover bg-center flex items-center justify-center">
      ...
      <div className="relative z-10 w-[80%] mx-auto grid lg:grid-cols-2 gap-6 h-full items-center">
        <div className="text-center lg:text-left">
          ...
          <div className="mt-8 flex-col space-y-6 sm:space-y-0 sm:flex-row items-center sm:space-x-6">

          <button className="px-8 hover:bg-yellow-400 transition-all duration-200 py-4 text-lg font-bold bg-[#0BC5EA] text-black items-center flex space-x-2 rounded-xl"><p>Download Resume</p>
                  <ArrowDownTrayIcon className="w-6 h-7 text-black"/>
          </button>

          </div>
        </div>
        <div className="hidden lg:flex relative mx-auto lg:mx-0 items-center justify-center -mt-8">
